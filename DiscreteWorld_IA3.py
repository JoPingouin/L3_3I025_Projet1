        ...
        while len(fioles)> 0 :
            ...
            for j in range(nbPlayers):
                ...
                if iteration==0 or j==1:
                    ...
                    if fiole_prise!=-1 and j==0:
                        #print("entré",fiole_prise)
                        if fiole_prise=='r':
                            nbfioleprise[0]+=1
                        if fiole_prise=='b':
                            nbfioleprise[1]+=1
                    ...
                    if cpt==1:
                        ...
                        for a in range(0,3):
                            tmp=nbfioleprisetmp.index(max(nbfioleprisetmp))
                            if tmp==0:
                                guesspref[a]='r'
                            if tmp==1:
                                guesspref[a]='b'
...
#                    print (" ")
                    ...
                    for i in fioles :
                        if fioles[i]==guesspref[0] and preferences[j][guesspref[0]] != 2:
                        ...
                        if fioles[i]==guesspref[1] and test_pref_dix!=True and preferences[j][guesspref[1]]!=2:
                            notre_len=len(astar.astar([i],[posPlayers[j]],20,wallStates))
                            son_len=len(astar.astar([i],[posPlayers[(j+1)%2]],20,wallStates))
                            #print("++++++++++++++++")
